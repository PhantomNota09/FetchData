...
- **Cryptocurrency Prices** – Fetch real-time Bitcoin and Ethereum prices from the CoinGecko API
- **Todo List** – Display todo items from the JSONPlaceholder API
- **User Directory** – Browse and view detailed user information from the JSONPlaceholder API
- **Pull to Refresh** – Update cryptocurrency prices with a simple pull gesture
- **Mock Network Layer** – Protocol-based mock managers for safe, isolated testing
- **Clean UIKit Implementation** – Built entirely with UIKit using programmatic UI and Auto Layout

## Architecture

The project follows a clean architecture pattern with:

- **MVVM Pattern** – Separation of concerns with dedicated ViewModels per feature
- **Protocol-Oriented Design** – Network managers conform to protocols, enabling easy swapping of real and mock implementations
